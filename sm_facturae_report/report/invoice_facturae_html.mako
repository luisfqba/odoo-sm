...
<body>
    %for o in objects :
                ...
                <td width="80%">
                    ...
                    <table class="basic_table" style="border-bottom:1px solid #002966;">
                        <tr>
                            ...
                            <td width="8%" class="cliente"><b>Referencia:</b></td>
                            <td width="17%" class="cliente"><b>${o.name or ''|entity}</b></td>
                        </tr>
                    </table>
                    
                    <%res_order=get_sale_order(o.sale_ids)%>
                    <table class="basic_table" style="border-bottom:1px solid #002966;">
                        <tr>
                            %if res_order:
                                <td width="13%" class="cliente"><b>Suc.</b></td>
                                <td width="55%" class="cliente">${res_order['sucursal'] or ''|entity}</td>
                                %if res_order['incoterm']:
                                    <td width="9%" class="cliente"><b>Incoterm:</b></td>
                                    <td width="23%" class="cliente"><b>${res_order['incoterm'] or ''|entity}</b></td>
                                %endif
                            %endif
                        </tr>
                    </table>
		...
		%if o.type == 'out_refund':
			<table class="basic_table" style="border-bottom:1px solid #002966;">
				<tr>
					<td width="33%" class="cliente"><b>Elaboró</b></td>
					<td width="33%" class="cliente"><b>Revisó</b></td>
					<td width="33%" class="cliente"><b>Autorizó</b></td>
				</tr>
			</table>
		%endif
